function vmap = get_map_2023a(ml_target, matvec_hessian, v_init)
%GET_MAP_MATLAB   
%
...
%opt  = optimoptions('fminunc', 'Algorithm', 'trust-region', 'SpecifyObjectiveGradient',true,... 
%     'HessianApproximation','lbfgs','Display','iter', 'MaxIterations', 500);

vmap = fminunc_2023a(@(v) obj(ml_target, v), v_init, opt);
