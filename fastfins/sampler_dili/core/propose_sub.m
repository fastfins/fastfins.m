function [alpha, next] = propose_sub(proposal, ml_target, P, kernel, curr, r_sub)
% subspace proposals for Hessian separated MCMC
% Tiangang Cui, 25/mar/2013

switch proposal
    case {'MALA'}
        [alpha, next] = propose_sub_mala(ml_target, P, kernel, curr, r_sub);
    case {'RW'}
        [alpha, next] = propose_sub_rw(ml_target, P, kernel, curr, r_sub);
    case {'OW_Prior'}
        [alpha, next] = propose_sub_prior(ml_target, P, kernel, curr, r_sub);
    case {'OW_Post'}
        [alpha, next] = propose_sub_post(ml_target, P, kernel, curr, r_sub);
end

end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function [alpha, next] = propose_sub_mala(ml_target, P, kernel, curr, r_sub)
...
function [alpha, next] = propose_sub_rw(ml_target, P, kernel, curr, r_sub)
...
function [alpha, next] = propose_sub_prior(ml_target, P, kernel, curr, r_sub)
...
function [alpha, next] = propose_sub_post(ml_target, P, kernel, curr, r_sub)
